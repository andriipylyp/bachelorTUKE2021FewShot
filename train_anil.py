...
from libs.models.anil_model import ConvolutionalNeuralNetwork
...
def ModelConvMiniImagenet(out_features, hidden_size=84):
    return ConvolutionalNeuralNetwork(3, out_features, hidden_size=hidden_size)
...
def train():
    ...
    filename = os.path.join('', 'anil_miniimagenet'
    ...
    plt.ylabel('Accuracy')
    plt.title('ANIL miniimagenet meta-training 15k tasks')
